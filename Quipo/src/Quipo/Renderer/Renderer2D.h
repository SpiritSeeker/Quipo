...
namespace Quipo {
  ...
  public:
    ...
    static void DrawRotatedQuad(const glm::vec2& position, float rotation, const glm::vec2& size, Ref<Texture2D>& texture, int tilingFactor = 1, const glm::vec4& color = glm::vec4(1.0f));
    static void DrawRotatedQuad(const glm::vec3& position, float rotation, const glm::vec2& size, Ref<Texture2D>& texture, int tilingFactor = 1, const glm::vec4& color = glm::vec4(1.0f));
  };
